      ...
      char* argv[])
{
    ...
    const int nComp = 3 + intComps.size() 
    ...
    // Find the principle curvature index
    int Mcurvloc = -1;
    int Gcurvloc = -1;
    for (int i=0; i<avgComps.size(); ++i)
    {
    ...
    // Set name for principle curvature zone
    outNames[oFirstKn] = std::string("principalCurv1");
    outNames[oFirstKn+1] = std::string("principalCurv2");
    outNames[oFirstKn+2] = std::string("principalCurvZone");
    ...
    Real K1_n_mean = 0;
    Real K2_n_mean = 0;
    std::vector<double> K1_p;
    std::vector<double> K2_p;
    std::vector<double> K1_n;
    std::vector<double> K2_n;
